...
// forgot password
export const passwordForgot = createAsyncThunk("FORGOT/PASSWORD" , async(email,thunkApi) =>{
  try {
    // console.log("Data in Slice",data)
...
export const passwordReset = createAsyncThunk("RESET/PASSWORD", async(data,thunkApi)=>{
  try {
    // console.log("Data in Slice",data)
...
export const googleLogin = createAsyncThunk("GOOGLE/LOGIN", async(data,thunkApi) =>{
  try {
    // console.log("Data in Slice",data)
